          ...
          <div className="information">
            ...
            <div className="things-i-enjoy">
              ...
              <MiniCard
                image="fa fa-spotify"
                title="Music"
                description="I love listening to music throughout the day, whether I am studying, exercising, or walking around Toronto. My favourite artists include Drake, The Weeknd, and PARTYNEXTDOOR."
              />
              <MiniCard
                image="fa fa-glasses"
                title="Learning"
              ...
              <MiniCard
                ...
                description="Exploring downtown Toronto and finding new places to eat and hang out with friends is always something I look forward to. Fun fact: I've been to every province in Canada!"
              />
            </div>
          </div>
        </div>
